...
import { playerDefensePower, analyzeCastle } from "../../sim/territory";
      ...
      <div className="scene-chip tl2" style={{ color: enclosure >= 0.99 ? "#8fe36b" : enclosure >= 0.7 ? "#f1d985" : "#e6a07a" }}>
        {hasKeep
          ? (enclosure >= 0.99 ? "🧱 Keep fully enclosed — walls at full strength in a siege."
            ...
            + ` An assault would fall on your ${layout.breachName}${layout.towersAtBreach ? ` — ${layout.towersAtBreach} tower(s) cover it` : " — no towers cover it"}.`
